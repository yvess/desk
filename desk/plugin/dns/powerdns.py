...
class Powerdns(DnsBase):
    ...
    def __init__(self, settings):
        ...
        self.doc = None
        self.domain_id = None
        if settings.powerdns_backend == 'sqlite':
    ...
    def add_record(self, key, value, type='A', ttl=86400, prio=None):
        if self.domain_id:
            self.cursor.execute(
             """INSERT INTO records (domain_id, name, content, type,ttl,prio)
                VALUES (self.domain_id,'test.com','dns-us1.powerdns.net','NS',86400,NULL)"""
            )
